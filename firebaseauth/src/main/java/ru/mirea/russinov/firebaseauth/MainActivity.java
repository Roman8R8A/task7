package ru.mirea.russinov.firebaseauth;
...
import ru.mirea.russinov.firebaseauth.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding.emailPasswordButtons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String password = binding.PasswordField.getText().toString(); // Укажите правильный пароль здесь
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            binding.EmailField.setText(getString(R.string.firebase_status_fmt, user.getUid()));
            ...
            binding.EmailField.setText(null);
